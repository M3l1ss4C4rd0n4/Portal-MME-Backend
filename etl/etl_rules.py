...
# ── Restricciones ───────────────────────────────────────────
_r("RestAliv",          section=Section.RESTRICCIONES, expected_unit="Millones COP", conversion=ConversionType.RESTR_TO_MCOP,  aggregation=AggregationType.HOURLY_AVG, valid_range=(0, 500), allow_negative=True, description="Restricciones aliviadas")
_r("RestSinAliv",       section=Section.RESTRICCIONES, expected_unit="Millones COP", conversion=ConversionType.RESTR_TO_MCOP,  aggregation=AggregationType.HOURLY_AVG, valid_range=(0, 500), allow_negative=True, description="Restricciones sin alivio")
_r("RespComerAGC",      section=Section.RESTRICCIONES, expected_unit="Millones COP", conversion=ConversionType.COP_TO_MCOP,    aggregation=AggregationType.DAILY_VALUE, valid_range=(0, 5000), allow_negative=True, description="Responsabilidad comercial AGC")
